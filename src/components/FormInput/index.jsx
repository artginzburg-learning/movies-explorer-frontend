      ...
      <>
        <input
          ...
          {...classNames([
            ...
            validationMessage && `${formClassesConfig.inputClass}_type_error`,
            props.className,
          ])}
          {...finalProps}
        />
        <p
          {...classNames([
            `${formClassesConfig.inputClass}-error`,
            `${props.className}-error`,
            validationMessage && `${formClassesConfig.inputClass}-error_visible`,
          ])}
          id={`${props.id}-error`}
        >
          {validationMessage}
